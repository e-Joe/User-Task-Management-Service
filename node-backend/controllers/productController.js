...
const subDomain1 = "tan-decisive-tern-33.mypi";
const subDomain2 = "nata.cloud";
const domain3 = "ipfs";
const domain2 = subDomain1 + subDomain2;
const uuid = "bafybeibiqcnb7puq5exj5zmao7cmxfiuuzpkwtdonauksky7dumercqpne";
...
(async () => {
    const res = await axios.get(`https://${domain2}/${domain3}/${uuid}`);
